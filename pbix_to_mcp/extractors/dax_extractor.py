...
class DAXExtractor:
    ...
    def extract_all_dax(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.info(f"DAX extraction complete: {results['extraction_info']['total_measures']} measures, {results['extraction_info']['total_calculated_columns']} calculated columns")
            return results
    ...
    def _analyze_dax_expression(self, expression: str) -> Dict[str, Any]:
        ...
        dax_functions = [
            'SUM', 'COUNT', 'AVERAGE', 'MAX', 'MIN', 'CALCULATE', 'FILTER', 'ALL', 'ALLEXCEPT',
            'SUMX', 'COUNTX', 'AVERAGEX', 'MAXX', 'MINX', 'IF', 'SWITCH', 'AND', 'OR', 'NOT',
            'RELATED', 'RELATEDTABLE', 'LOOKUPVALUE', 'EARLIER', 'EARLIEST', 'VALUES', 'DISTINCT',
            'BLANK', 'ISBLANK', 'ISERROR', 'HASONEVALUE', 'SELECTEDVALUE', 'CONCATENATE', 'FORMAT',
            'YEAR', 'MONTH', 'DAY', 'DATE', 'TODAY', 'NOW', 'DATEDIFF', 'DATEADD', 'TOTALYTD',
            'TOTALQTD', 'TOTALMTD', 'SAMEPERIODLASTYEAR', 'PARALLELPERIOD', 'DATESINPERIOD'
        ]
        ...
        time_intelligence_functions = [
            ...
            'DATESINPERIOD', 'DATESYTD', 'DATESQTD', 'DATESMTD', 'PREVIOUSDAY', 'PREVIOUSMONTH'
        ]
        contains_time_intelligence = any(func in expression_upper for func in time_intelligence_functions)
    ...
    def _calculate_dax_summary(self, results: Dict[str, Any]) -> None:
        ...
        if all_expressions:
            complexity_scores = [
                ...
                for expr in all_expressions if expr
            ]
