...
Examples:
  ...
  %(prog)s report.pbix --complete-package
    ...
    parser.add_argument(
        "pbix_file",
        help="Path to the .pbix file to convert"
    )
    
    # Output options
    parser.add_argument(
        "-o", "--output-dir",
        help="Output directory (default: {pbix_name}_mcp)"
    )
    
    parser.add_argument(
        "--config-name",
        help="Name for the MCP config file (default: {pbix_name}_mcp_config.yaml)"
    )
    ...
    parser.add_argument(
        "--skip-data",
        action="store_true",
        help="Skip data model extraction"
    )
    
    parser.add_argument(
        "--skip-ui",
        action="store_true", 
        help="Skip UI structure extraction"
    )
    
    parser.add_argument(
        "--skip-dax",
        action="store_true",
        help="Skip DAX expressions extraction"
    )
    ...
    parser.add_argument(
        "--package-name",
        help="Name for the complete package (default: {pbix_name}_mcp_package)"
    )
