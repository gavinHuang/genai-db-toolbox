...
class MCPConfigGenerator:
    ...
    def generate_config(self, 
                       ...
                       config_name: str,
                       toolsets: Optional[List[str]] = None) -> Path:
        """
    ...
    def _generate_core_tools(self, source_name: str) -> Dict[str, Any]:
        ...
        return {
            "execute_sql": {
                ...
                "statement": YAMLMultilineStr("-- Replace this with your SQL statement\nSELECT 'Replace this statement with your SQL';")
            },
            ...
            "list_powerbi_tables": {
                ...
                "statement": YAMLMultilineStr("""SELECT 
                name as table_name,
                type as object_type,
    ...
    def _generate_data_tools(self, source_name: str, data_model: Dict[str, Any]) -> Dict[str, Any]:
        ...
        tools.update({
            ...
            "query_table_with_filter": {
                ...
                "statement": YAMLMultilineStr("""SELECT * FROM {{.tableName}} 
            WHERE {{.columnName}} = ?
            ORDER BY {{.orderBy}} 
            LIMIT ?;"""),
                "templateParameters": [
        ...
        if (any("backorder" in name for name in table_names) and 
            any("risk" in name for name in table_names)):
    ...
    def _generate_toolsets(self, extraction_results: Dict[str, Any], custom_toolsets: Optional[List[str]] = None) -> Dict[str, List[str]]:
